...
if SourcePhoto is not None and YourPhoto is not None:
  ...
  if detectBtm:
    ...
    with col1:
      face1 = st.number_input("Choose Face Number to swap", min_value=0, max_value=100, value=1)
      face1 = face1 - 1
      print(face1)
    
    with col2:
      face2 = st.number_input("Choose Face Number to swap ", min_value=0, max_value=100, value=1)
      face2 = face2 - 1
      print(face2)
